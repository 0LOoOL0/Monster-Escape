...
public class HorrorSchoolSubtitleController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        StartCoroutine(ShowSubtitle(monsterApproachSubtitle, "I should find the puzzles...", 5f, 0f));
        StartCoroutine(ShowSubtitle(solvePuzzleSubtitle, "A laptop and a phone", 5f, 6f));
        ...
        StartCoroutine(ShowSubtitle(lockedDoorSubtitle, "I should be faster", 5f, 24f));

        // Starting delayed coroutines
        StartCoroutine(DelayedSubtitleCoroutine(monsterApproachSubtitle, "Hurry!", 5f, 30f));
        ...
        StartCoroutine(DelayedSubtitleCoroutine(lockedDoorSubtitle, "Use the clues to open the door!", 5f, 54f));
    }
